...
\clearpage
\large
% https://stackoverflow.com/a/2785740/
...
\end{center}
\item You may want to verify that your changes appear as you intended using the \ref{verifying-changes} section
\end{enumerate}


\subsection{Verifying your schedule changes}
\label{verifying-changes}
\begin{enumerate}

\item {To verify that your schedule change for the current day worked, open a new tab and navigate back to  \href{https://web.classclock.app}{web.classclock.app}.
...
\begin{center}
\includegraphics[width=3.9992in,height=4.9992in]{images/classclock-schedule-updated.png}
\end{center}
\end{enumerate}
